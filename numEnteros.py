...
if num2 > num1 < num3:
    ...
    print("El numero menor es el segundo numero, el cual es: ",num2)
elif num1 < num3 > num2:
...
if num2 > num1 > num3:
    print("El numero del centro es el primer numero, el cual es: ",num1)
elif num1 > num2 > num3:
    print("El numero del centro es el segundo numero, el cual es: ",num2)
elif num1 > num3 > num2:
    print("El numero  es el tercer numero, el cual es: ",num3)
else:
    print("Todos los numeros son iguales")
